...
%% SVM train using response of single unit
reN = 5;                                                                   
num_Sample_singe = 20;                                                     
Cell_SVM_single = cell(3,1);                                               % 1: Face-selective; 2: Non-selective; 3: Response shuffled
...
%% SVM train using response of multiple units   
reN = 10;                                                                  % 계산 시간을 줄이기 위해 작은 숫자로 세팅 (number 보고 영어로)
numFace_ratio = 10;                                                        % 계산 시간을 줄이기 위해 작은 숫자로 세팅
...
tmpColor_SVM = [1 0 0; 0.7 0.7 0.7; 0 0 0]; 
...
xticklabels({'Face-selective','Non-selective','Response shuffled'}); ylabel('Correct ratio');
...
legend([s1,s2,s3],'Face-selective','Non-selective','All units','Location','northwest')
...
xticklabels({'All unit','Face-selective'}); ylabel('Correct ratio');
