...
%% Analysis for invariance to image variation (Fig 4a-f)
...
for vtype = 1:TT
    ...
    title('Response of face units (Fig 4c,d)'); legend([s1,s2],{'Face stimulus','Non-face stimulus'},'Location','northeast')
    ...
    title('Image correlation (Fig 4e)'); legend([s1,s2],{'Face vs. Shifted face','Face vs. Shifted non-face'},'Location','southeast')
