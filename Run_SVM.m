...
toc
Cell_SVM_single{1} = array_SVM; Cell_SVM_single{2} = array_SVM_shuf;
...
sgtitle('Face detection task using the response of face units (Fig 3b-d)')
...
%% Face detection performance with variation of the low-level features (Fig.S11) 
% This section shows the data of figures in our manuscript

load('Data_SVM_invariance.mat')
figure('units','normalized','outerposition',[0 0 2/3 0.5]);
subplot(2,6,[1 2 7 8]); hold on; iVar = 1;
bar([1],mean(Cell_SVM_Var{iVar,1}),0.5,'facecolor',[.7 .7 .7]); errorbar([1],mean(Cell_SVM_Var{iVar,1}),std(Cell_SVM_Var{iVar,1}),'k')
bar([2],mean(Cell_SVM_Var{iVar,2}),0.5,'facecolor',[1 0 0]); errorbar([2],mean(Cell_SVM_Var{iVar,2}),std(Cell_SVM_Var{iVar,2}),'k')
bar([3],mean(Cell_SVM_Var{iVar,3}),0.5,'facecolor',[0 0 0]); errorbar([3],mean(Cell_SVM_Var{iVar,3}),std(Cell_SVM_Var{iVar,3}),'k')
ylim([0.4 1]); ylabel('Correct ratio'); xticks([1:3]); xlim([0.5 3.5]); xticklabels({['Test 1'];['Test 2'];['Response\newline{  shuffled}']}); title('Translation')

subplot(2,6,[3 4 9 10]); hold on; iVar = 2;
bar([1],mean(Cell_SVM_Var{iVar,1}),0.5,'facecolor',[.7 .7 .7]); errorbar([1],mean(Cell_SVM_Var{iVar,1}),std(Cell_SVM_Var{iVar,1}),'k')
bar([2],mean(Cell_SVM_Var{iVar,2}),0.5,'facecolor',[1 0 0]); errorbar([2],mean(Cell_SVM_Var{iVar,2}),std(Cell_SVM_Var{iVar,2}),'k')
bar([3],mean(Cell_SVM_Var{iVar,3}),0.5,'facecolor',[0 0 0]); errorbar([3],mean(Cell_SVM_Var{iVar,3}),std(Cell_SVM_Var{iVar,3}),'k')
ylim([0.4 1]); ylabel('Correct ratio'); xticks([1:3]); xlim([0.5 3.5]); xticklabels({['Test 1'];['Test 2'];['Response\newline{  shuffled}']}); title('Scaling')

subplot(2,6,[5 6 11 12]); hold on; iVar = 3;
bar([1],mean(Cell_SVM_Var{iVar,1}),0.5,'facecolor',[.7 .7 .7]); errorbar([1],mean(Cell_SVM_Var{iVar,1}),std(Cell_SVM_Var{iVar,1}),'k')
bar([2],mean(Cell_SVM_Var{iVar,2}),0.5,'facecolor',[1 0 0]); errorbar([2],mean(Cell_SVM_Var{iVar,2}),std(Cell_SVM_Var{iVar,2}),'k')
bar([3],mean(Cell_SVM_Var{iVar,3}),0.5,'facecolor',[0 0 0]); errorbar([3],mean(Cell_SVM_Var{iVar,3}),std(Cell_SVM_Var{iVar,3}),'k')
ylim([0.4 1]); ylabel('Correct ratio'); xticks([1:3]); xlim([0.5 3.5]); xticklabels({['Test 1'];['Test 2'];['Response\newline{  shuffled}']}); title('Rotation')
sgtitle('Face detection performance with variation of the low-level features (Fig.S11)')

%% Face detection performance of selective units in untrained networks (Fig.S12) 
% This section shows the data of figures in our manuscript

load('Data_SVM_NeuronType.mat')
figure('units','normalized','outerposition',[2/3 0 1/3 0.5]); hold on
bar([1],mean(Cell_SVM_Neuron{1}),0.5,'facecolor','w'); errorbar([1],mean(Cell_SVM_Neuron{1}),std(Cell_SVM_Neuron{1}),'k')
bar([2],mean(Cell_SVM_Neuron{2}),0.5,'facecolor','c'); errorbar([2],mean(Cell_SVM_Neuron{2}),std(Cell_SVM_Neuron{2}),'k')
bar([3],mean(Cell_SVM_Neuron{3}),0.5,'facecolor','r'); errorbar([3],mean(Cell_SVM_Neuron{3}),std(Cell_SVM_Neuron{3}),'k')
bar([4],mean(Cell_SVM_Neuron{4}),0.5,'facecolor',[.7 .7 .7]); errorbar([4],mean(Cell_SVM_Neuron{4}),std(Cell_SVM_Neuron{4}),'k')
bar([5],mean(Cell_SVM_Neuron{5}),0.5,'facecolor','r'); errorbar([5],mean(Cell_SVM_Neuron{5}),std(Cell_SVM_Neuron{5}),'k')
ylim([0.4 1]); ylabel('Correct ratio'); xticks([1:5]); xlim([0.5 5.5]); 
xticklabels({['       All\newline{selective unit}'];['   Non-face-\newline{selective unit}'];['       Face-\newline{  selective unit}'];...
    ['       Non-\newline{  selective unit}'];['Response\newline{  shuffled}']});
sgtitle('Face detection performance of selective units in untrained networks (Fig.S12) ')